...
import { fetchSensorData, SensorData, getCacheTimestamp, debugCachedData } from '../services/api';
import {
  calculateStats,
  calculateTrend,
  detectAnomalies,
...
const Reports: React.FC = () => {
  ...
  // Analiz sonuçları
  const [stats, setStats] = useState<any | null>(null); // SensorStats yerine any kullanıldığı için
                    ...
                    <div className="card-body">
                      ...
                      <div className="d-grid gap-2 mt-3">
                        ...
                        <button 
                          ...
                          onClick={() => {
                            console.log('🔍 REPORTS DEBUG: Veri durumu kontrol ediliyor...');
              ...
              {allData.length > 0 && (
                <div className="row">
                  <div className="col-12">
                    <div className={`card ${isDarkMode ? 'bg-secondary' : 'bg-light'}`}>
                      <div className="card-body">
                        <h6 className="card-title">📋 Ham Veri Tablosu ({allData.length} kayıt)</h6>
                              ...
                              {allData
                                ...
                                .map((data, index) => (
                                  <tr key={data.id || index}>
                                    ...
                                    <td>
                                      <span className={`badge ${data.temperature > 25 || data.humidity > 70 ? 'bg-danger' : 'bg-success'}`}>
